...
var _pokemon_action = __webpack_require__(/*! ./actions/pokemon_action */ "./frontend/actions/pokemon_action.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.receiveAllPokemon = _pokemon_action.receiveAllPokemon;
  window.x = 5;

  var store = (0, _store.configureStore)();
  window.getState = store.getState;
  window.dispatch = store.dispatch;
  window.requestAllPokemon = _pokemon_action.requestAllPokemon;
...
var pokemonReducer = exports.pokemonReducer = function pokemonReducer() {
  ...
  Object.freeze(state);
  switch (action.type) {
    case _pokemon_action.RECEIVE_ALL_POKEMON:
...
var configureStore = exports.configureStore = function configureStore() {
  return (0, _redux.createStore)(_root_reducer.rootReducer, (0, _redux.applyMiddleware)(_thunk.thunk, _reduxLogger2.default));
};
